...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { company_id: @user_profile.company_id, email: @user_profile.email, name: @user_profile.name, profile_pic: @user_profile.profile_pic }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { company_id: @user_profile.company_id, email: @user_profile.email, name: @user_profile.name, profile_pic: @user_profile.profile_pic }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
